...
/*     */ 
/*     */ public class DungeonGeneratorFortIce
...
/*     */         }
/*     */         
/*  33 */         addBlockAndMetadata(par1 + v1, getTop(par1 + v1, par3 + v2) - 1, par3 + v2, 79, v3);
/*  34 */         addBlockAndMetadata(par1 + v1, getTop(par1 + v1, par3 + v2) - 2, par3 + v2, 79, v3);
/*  35 */         addBlockAndMetadata(par1 + v1, getTop(par1 + v1, par3 + v2) - 3, par3 + v2, 79, v3);
/*  36 */         addBlockAndMetadata(par1 + v1, getTop(par1 + v1, par3 + v2) - 4, par3 + v2, 79, v3);
/*  37 */         addBlockAndMetadata(par1 + v1, getTop(par1 + v1, par3 + v2) - 5, par3 + v2, 79, v3);
/*     */       }
/*     */     }
/*     */     
...
/*     */       }
/*     */       
/*  80 */       addBlockAndMetadata(par1, par2 + v1, par3, 79, id);
/*     */     }
/*     */     
...
/*     */       }
/*     */       
/*  89 */       addBlockAndMetadata(par1 + 1, par2 + v1, par3, 79, id);
/*  90 */       addBlockAndMetadata(par1 - 1, par2 + v1, par3, 79, id);
/*     */     }
/*     */     
/*  93 */     return true;
/*     */   }
...
/*     */       }
/*     */       
/* 105 */       addBlockAndMetadata(par1, par2 + v1, par3, 79, id);
/*     */     }
/*     */     
...
/*     */       }
/*     */       
/* 114 */       addBlockAndMetadata(par1, par2 + v1, par3 + 1, 79, id);
/* 115 */       addBlockAndMetadata(par1, par2 + v1, par3 - 1, 79, id);
/*     */     }
/*     */     
/* 118 */     return true;
/*     */   }
...
/*     */           }
/*     */           
/* 130 */           addBlockAndMetadata(par1 + v2, par2 + v1, par3 + v3, 79, id);
/*     */         }
/*     */       }
/*     */     }
/*     */     
...
/* Location:              C:\Users\IyadE\Desktop\Mod Porting Tools\dungeonpack-1.8.jar!\de\stuuupiiid\dungeonpack\DungeonGeneratorFortIce.class
